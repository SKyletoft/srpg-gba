...
void ScrollingRainbow::load_tilesets() {
	u32 const nums[] = {
		0x11111111,
		0x22222222,
		0x33333333,
	...
	std::span<STile> const tiles{tiles::CHARBLOCKS[BG0_TILE_SOURCE], 16};
...
void ScrollingRainbow::load_palettes() {
...
ScreenEntry ScrollingRainbow::get_tile(s16 x, s16 y) {
